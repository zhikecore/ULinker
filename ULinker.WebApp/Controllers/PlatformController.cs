...
namespace ULinker.WebApp.Controllers
{
    public class PlatformController : BaseController
    {
        ...
        //combox
        public JsonResult GetPlatformsForCombox()
        {
            return Json(PlatformService.Instance.GetPlatformsForCombox(),JsonRequestBehavior.AllowGet);
        }
        ...
        {
            int total = 0;
            var filters = PlatformService.Instance.GetBySomeWhere(keyword, dtParams.DisplayStart, dtParams.DisplayLength, out total);
            ...
            )
        {
            ...
            try
            {
                ...
                bool bRet = PlatformService.Instance.Create(platform);
            ...
            string description)
        {
            ...
            try
            {
                ...
                Platform originPlatform = PlatformService.Instance.GetById(id);
                ...
                originPlatform.Name = name;
                originPlatform.Description = description;
                
                bool bRet = PlatformService.Instance.Update(originPlatform);
        ...
        public JsonResult PhysicDelete(int id)
        {
            ...
            try
            {
                ...
                Platform originPlatformp =PlatformService.Instance.GetById(id);
                if (originPlatformp == null)
                {
                    oResult = new
                    {
                        Bresult = false,
                ...
                bool bRet = PlatformService.Instance.PhysicDelete(id, currentAdminUser.Account);
        ...
        private Object ToJson(Platform model, DataTableParams dtParams)
        {
